...
import com.Spring.WebApp.repo.PostRepository;
...
public class BlogController {
    ...
    public String blogPostUpdate(@PathVariable(value = "id") long id, @RequestParam String title, String preview, String full_text, Model model){
